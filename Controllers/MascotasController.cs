...
namespace ApiVete.Controllers
{
    ...
    public class MascotasController : ControllerBase
    {
        ...
        public MascotasController(ApiDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Mascota>> PostMascota(Mascota mascota)
        {
            ...
            return CreatedAtAction(nameof(GetMascota), new { id = mascota.eCodMascota }, mascota);
        }
        ...
        {
            return _context.Mascotas.Any(e => e.eCodMascota == id);
        }
    }
}
